    ...
    <form onSubmit={handleSubmit} className="space-y-4 max-w-4xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="md:col-span-2">
            <label htmlFor="paymentMethod" className="block text-sm font-medium text-gray-700">Metode</label>
            <select
              id="paymentMethod"
              value={paymentMethod}
      ...
      {isSuccess && <p className="text-green-600 text-sm">Transaksi berhasil ditambahkan!</p>}
